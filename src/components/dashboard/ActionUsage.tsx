...
export const ActionUsage = () => {
  const { actionsUsed, actionsLimit, getActionUsagePercentage, getRemainingActions } = useActions();
    ...
    <Card className="bg-white/5 border border-white/10 backdrop-blur-sm">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3 pt-2">
          <h4 className="text-sm font-semibold text-white font-satoshi">Actions consume:</h4>
