  ...
  const fetchStats = async () => {
    try {
      ...
      const { data: profiles } = await supabase
        .from("profiles")
        .select(
          "subscription_tier, subscription_price, billing_cycle, subscription_end, access_used, access_limit"
        );
      ...
      if (profiles) {
        ...
        activeProfiles.forEach((profile) => {
          ...
          const monthlyRevenue =
            profile.billing_cycle === "yearly" ? price / 12 : price; // Convert yearly to monthly recurring
      ...
      setStats({
        ...
        totalRevenue: totalRevenue, // Already converted from cents to dollars in the loop
        monthlyGrowth,
        activeSubscriptions,
      });
    } catch (error) {
        ...
        {statCards.map((card, index) => (
          ...
          >
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <div
                className={`w-8 h-8 rounded ${card.color} flex items-center justify-center`}
              >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm text-white">
                    New investor application submitted
                  </p>
